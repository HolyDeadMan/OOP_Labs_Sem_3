...
void menu()
{
	...
	std::cout << "1) Add pentagon(3 sides)" << std::endl;
	std::cout << "2) Add octagon(1 side)" << std::endl;
	std::cout << "3) Add hexagon(1 side)" << std::endl;
	std::cout << "4) Delete all figure the same type of wood. 1)Triangle 2)Octagon 3)Hexagon" << std::endl;
